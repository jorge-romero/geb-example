        ...
        return (
            <Container id='ToDoList'>
                <InputForm onSubmit={this.handleSubmit}>
                    <InputText id='inputText' value ={this.state.inputText} onChange={this.updateInput} />
                    <Button id='addButton' disabled={this.state.submitDisabled} type="submit">Add</Button>
                </InputForm>
                <List id='todoList' items={this.state.toDoItems} removeItem={this.delToDo} />
            </Container>
        )
    }
}